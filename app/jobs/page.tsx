...
import { getEscrows, subscribe, submitProposal, reloadEscrows } from "@/lib/escrow-store";
                ...
                <div className="flex flex-col gap-8">
                    ...
                    {isLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-32 text-center">
                            ...
                            <p className="text-slate-300 text-xs mt-1">Check back later or post a new project</p>
                        </div>
                    ) : (
